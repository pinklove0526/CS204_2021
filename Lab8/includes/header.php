            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <?php else: ?>
                            <li class="nav-item actvie"><a class="nav-link" href="login.php"><ion-icon name="person-circle-outline"></ion-icon> Login / create account <span class="sr-only">(current)</span></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
            </div>
