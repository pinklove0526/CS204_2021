<?php
//User errors associative array to track errors and use as a bool. Decide on login / creating account. Passed by reference
$errors = [];
...
//Check the create new user form
function checkCreate($post, &$errors, $conn)
{
    ...
    //Check the username length, then ensure the name doesn't exist in the database.
...
//Fetch a user from the database based on the user name
