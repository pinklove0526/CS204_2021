...
//Add event listener, prevent default submission and get textarea value
    ...
    xhr.onload = function()
    {
        if (this.status == 200)
        {
            if (this.responseText == true)
            {
                ...
                {
                    parent_card.remove();
                    notification("Comment successfully removed!", "success", "checkmark-outline");
                }, 400);
            }
            else
...
{
    //Needed values: comment_id (reply button), review_value and review_type
